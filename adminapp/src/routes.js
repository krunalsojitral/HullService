...
const Organization = React.lazy(() => import('./views/pages/organization/Organization'))
const OrganizationAddEditForm = React.lazy(() => import('./views/pages/organization/AddEditForm'))
...
const routes = [
  ...
  { path: '/forumheadingadd', name: 'Threads Topic Add', component: ForumheadingAddEditForm },
  { path: '/forumheadingedit/:id', name: 'Threads Topic Edit', component: ForumheadingAddEditForm },
  ...
  { path: '/forum-request', name: 'Threads Request', component: ForumRequestDemoTable },
