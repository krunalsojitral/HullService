...
const CurrentParticipateDetail = ({ match }) => {

  const [details, setDetails] = useState({})

  React.useEffect(() => {
    axios.post(api_url + '/researches/getCurrentParticipateById', { 'researches_participate_id': match.params.id }).then((result) => {
...
export default CurrentParticipateDetail
