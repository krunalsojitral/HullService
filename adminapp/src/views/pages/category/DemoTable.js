...
const DemoTable = () => {
  ...
  const updateItemStatus = (item, status) => {
    ...
    if (status == 1) {
      var message = 'Are you sure you want to activate the category ?'
    } else {
      var message = 'Are you sure you want to deactivate the category ?'
    }
    Swal.fire({
      //title: 'warning!',
      icon: 'warning',
          ...
          status: (item) => (
            <td class="tooltip-box">
              {item.status === 1 ? (
                ...
                >
                  Active{" "}
                  <span class="tooltip-title">De-activating the forum will remove the category from the front end.</span>
                </a>
              ) : (
                <a
                  href
                ...
                >
                    Inactive
                    <span class="tooltip-title">Activating the forum will add the category back on the front end.</span>
                </a>
              )}
