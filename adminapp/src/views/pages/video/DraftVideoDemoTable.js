...
const DraftVideoDemoTable = () => {
  ...
  const updateItemStatus = (item, status) => {
    ...
    Swal.fire({
      ...
      if (results.isConfirmed) { 
        ...
        axios.post(api_url + "/video/changeDraftvideoStatus", obj)
          .then((result) => {
  ...
  const getNewList = () => {
    axios.get(api_url + '/video/draftvideoList', {}).then((result) => {
      if (result.data.status) {
...
export default DraftVideoDemoTable
