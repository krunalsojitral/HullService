            ...
            status: (item) => (
              <td class="tooltip-box">
                {item.status === 1 ? (
                  ...
                  >
                    Active{" "}
                    <span class="tooltip-title">De-activating the article will remove the article from the front end.</span>
                  </a>
                ) : (
                  <a
                    href
                  ...
                  >
                    Inactive
                    <span class="tooltip-title">Activating the article will add the article back on the front end.</span>
                  </a>
                )}
