...
const AddEditForm = ({ match }) => {
  ...
  const [cohostLoop, setCohostLoop] = React.useState(0);
  ...
  var speaker_email = watch("speaker_email");
  ...
  const preview = () => {
    var obj = {
      cost:
        control._fields.cost && control._fields.cost._f.value
          ? control._fields.cost._f.value
          : "",
      purchase_type:
        control._fields.purchase_type && control._fields.purchase_type._f.value
          ? control._fields.purchase_type._f.value
          : "",
      title:
        control._fields.title && control._fields.title._f.value
          ? control._fields.title._f.value
          : "",
      description: contentEditor ? contentEditor : "",
      start_date:
        control._fields.start_date && control._fields.start_date._f.value
          ? control._fields.start_date._f.value
          : "",
      start_time:
        control._fields.start_time && control._fields.start_time._f.value
          ? control._fields.start_time._f.value
          : "",
      end_date:
        control._fields.end_date && control._fields.end_date._f.value
          ? control._fields.end_date._f.value
          : "",
      end_time:
    ...
    axios
      .post(api_url + "/common/addPreview", formData)
      .then((result) => {
        if (result.data.status) {
      ...
      inputItems.push(
        ...
        >
          ...
          <CRow>
            <CCol xs="12">
              <CFormGroup>
                <CLabel htmlFor="Organization">Enter Co host Name</CLabel>
                <Controller
          ...
          <CRow>
            <CCol xs="12">
              <CFormGroup>
                <CLabel htmlFor="Organization">Enter Co host Email</CLabel>
                <Controller
