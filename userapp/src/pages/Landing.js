      ...
      <div className="wrapper">
        ...
        <section className="upcoming-event-sec">
                  ...
                  <div className="row">
                    <div className="col-md-6 order-md-first order-last">
                      <div className="image-holder">
                        <img
                          src="/images/upcoming-img.png"
                          alt=""
                          className="img-fluid wow animate__fadeInLeft"
                          data-wow-duration="1000ms"
                          data-wow-delay="1000ms"
                        />
                        <div className="image-shape">
                          <img
                            src="/images/upcoming-round.png"
                            alt=""
                            className="img-fluid wow animate__fadeIn"
                            data-wow-duration="1000ms"
                            data-wow-delay="1000ms"
                    ...
                    <div className="col-md-6 order-md-last order-first">
                      <div className="text-box">
                        ...
                        >
                          {" "}
                          Luminary Speaker Series: ….with Dr. Bruce Perry
                        </h4>
                        <p
                          className="wow animate__fadeInUp"
                        ...
                        >
                          ...
                          elit. Consectetur porttitor consequat, diam nunc
                          adipiscing urna semper. Malesuada eu fringilla
                          faucibus scelerisque phasellus tortor. Bibendum.
                        </p>
                        <a
                          href="#"
                          className="detail-btn wow animate__fadeInUp"
          ...
          <div className="event-shape">
            <img
              src="/images/upcoming-event-shape.png"
              alt=""
              className="img-fluid  wow animate__fadeIn"
              data-wow-duration="1000ms"
              data-wow-delay="1000ms"
                  ...
                  <div className="row">
                    ...
                    <div className="col-md-4">
                      <div className="training-courses-box wow animate__fadeInUp">
                        <div
                          className="courses-detail informed-bg wow animate__fadeInUp"
                          data-wow-duration="1000ms"
                          data-wow-delay="1000ms"
                        >
                          <span>
                            ...
                            >
                              <path
                                d="M74.9375 67.8374L50 81.8648L25.0625 67.8374V53.017L17.9375 49.0586V72.0042L50 90.0394L82.0625 72.0042V49.0586L74.9375 53.017V67.8374Z"
                                fill="white"
                              />
                              <path
                                d="M50 0L0.125 25.8611V32.0362L50 59.7438L92.75 35.9946V55.6692H99.875V25.8611L50 0ZM85.625 31.8022L78.5 35.7604L50 51.5946L21.5 35.7604L14.375 31.8022L9.43671 29.0586L50 8.02587L90.5633 29.0586L85.625 31.8022Z"
                                fill="white"
                              />
                            </svg>
                          </span>
                        ...
                        <div
                          className="courses-detail focused-bg wow animate__fadeInUp"
                          data-wow-duration="1000ms"
                          data-wow-delay="1000ms"
                        >
                          <span>
                    ...
                    <div className="col-md-4">
                      <div className="training-courses-box courses-box-last ">
                        <div
                          className="courses-detail reflective-bg wow animate__fadeInUp"
                          data-wow-duration="1000ms"
                          data-wow-delay="1000ms"
                        >
                          <span>
