                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-12">
                                ...
                                <div className="image-holder">
                                    <img src="images/partner-img.png" alt="" className="img-fluid wow animate__fadeIn" data-wow-duration="800ms" data-wow-delay="10ms" />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-12">
                                ...
                                <div className="image-holder">
                                    <img src="images/partner-img.png" alt="" className="img-fluid wow animate__fadeIn" data-wow-duration="800ms" data-wow-delay="0ms" data-wow-offset="1"/>
                                </div>
                            </div>
                        </div>
                    </div>
