                            ...
                            <div className="row">
                                <div className="col-md-6">
                                    <div className="text-box">
                                        <h2 className="wow animate__fadeIn" data-wow-duration="800ms" data-wow-delay="10ms" data-wow-offset="1">Contact Us</h2>
                                    </div>
                                </div>
                                <div className="col-md-6">
                                    ...
                                    <div className="contact-left">
                                        <div className="contact-info">
                                            <div className="heading-second">
                                                <h3 className="wow animate__fadeIn" data-wow-duration="800ms" data-wow-delay="0ms" data-wow-offset="1">Connect with us</h3>
                                            </div>
                                            <ul>
                                                <li className="wow animate__fadeInUp" data-wow-duration="300ms" data-wow-delay="0ms" data-wow-offset="1"><span><svg width="22" height="28" viewBox="0 0 22 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                </svg></span>2266 Woodpark Avenue S.W., Calgary, AB, T2W 2Z8 </li>
                                                <li className="wow animate__fadeInUp" data-wow-duration="800ms" data-wow-delay="0ms" data-wow-offset="1"><span><svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <li className="wow animate__fadeInUp" data-wow-duration="1100ms" data-wow-delay="0ms" data-wow-offset="1"><span><svg width="31" height="24" viewBox="0 0 31 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                </svg></span>info@pathwaystoprevention.ca</li>
                                            </ul>
                                        </div>
                                        <div className="contact-social">
                                            <div className="heading-second">
                                                <h3 className="wow animate__fadeIn" data-wow-duration="800ms" data-wow-delay="10ms">Connect with us </h3>
                                            </div>
